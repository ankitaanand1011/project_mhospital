...
public class M_SundayAdapter extends BaseAdapter {
    String TAG="HOSPITAL";
    ...
    public M_SundayAdapter(FragmentActivity activity, ArrayList<HashMap<String, String>> arrSunday, String rbranch, String rdep, String rdepsub, FragmentTransaction fragmentTransaction) {
        this.mContext = activity;
        global = (GlobalClass)mContext.getApplicationContext();
        this.arrayList = arrSunday;
    ...
    public int getCount() {
        ...
        return global.getArrSunday().size();
    }
