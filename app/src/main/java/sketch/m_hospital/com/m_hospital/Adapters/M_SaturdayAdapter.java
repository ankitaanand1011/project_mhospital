...
public class M_SaturdayAdapter extends BaseAdapter {
    String TAG="M";
    ...
    public M_SaturdayAdapter(Context c, ArrayList<HashMap<String , String>> arrayList, String rbranch, String rdep, String rdepsub, FragmentTransaction fragmentTransaction) {
        mContext = c;
    ...
    public int getCount() {
        ...
        return global.getArrSaturday().size();
    }
