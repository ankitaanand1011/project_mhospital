...
public class M_TuesdayAdapter extends BaseAdapter {
    String TAG="M";
    ...
    public M_TuesdayAdapter(FragmentActivity c, ArrayList<HashMap<String , String>> arrayList, String rbranch, String rdep, String rdepsub, FragmentTransaction fragmentTransaction) {
        mContext = c;
    ...
    public int getCount() {
        ...
        return global.getArrTuesday().size();
    }
