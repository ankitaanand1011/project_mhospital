...
public class M_WednesdayAdapter extends BaseAdapter {
    String TAG="M";
    ...
    public M_WednesdayAdapter(Context c, ArrayList<HashMap<String , String>> arrayList, String rbranch, String rdep, String rdepsub, FragmentTransaction fragmentTransaction) {
        mContext = c;
    ...
    public int getCount() {
        ...
        return global.getArrWednesday().size();
    }
