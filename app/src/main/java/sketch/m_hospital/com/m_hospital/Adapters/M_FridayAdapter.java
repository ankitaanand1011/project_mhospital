...
public class M_FridayAdapter extends BaseAdapter {
    String TAG="M";
    ...
    public M_FridayAdapter(Context c, ArrayList<HashMap<String , String>> arrayList, String rbranch, String rdep, String rdepsub, FragmentTransaction fragmentTransaction) {
        mContext = c;
    ...
    public int getCount() {
        ...
        return global.getArrFriday().size();
    }
